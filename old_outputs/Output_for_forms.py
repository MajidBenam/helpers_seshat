...
class Annual_wagesForm(forms.ModelForm):
    class Meta:
        ...
        widgets = dict(commonwidgets)
        widgets['annual_wages'] = forms.NumberInput(attrs={'class': 'form-control  mb-3', })
        widgets['job_category'] = forms.Select(attrs={'class': 'form-control  mb-3', })
        widgets['job_description'] = forms.Select(attrs={'class': 'form-control  mb-3', })
...
class Rate_of_returnForm(forms.ModelForm):
    class Meta:
        ...
        widgets = dict(commonwidgets)
        widgets['rate_of_return'] = forms.NumberInput(attrs={'class': 'form-control  mb-3', })
        widgets['job_category'] = forms.Select(attrs={'class': 'form-control  mb-3', })
        widgets['job_description'] = forms.Select(attrs={'class': 'form-control  mb-3', })
...
class Disease_eventForm(forms.ModelForm):
    class Meta:
        ...
        widgets['longitude'] = forms.NumberInput(attrs={'class': 'form-control  mb-3', })
        widgets['latitude'] = forms.NumberInput(attrs={'class': 'form-control  mb-3', })
        widgets['disease_event'] = forms.NumberInput(attrs={'class': 'form-control  mb-3', })
        widgets['elevation'] = forms.NumberInput(attrs={'class': 'form-control  mb-3', })
        widgets['sub_category'] = forms.Select(attrs={'class': 'form-control  mb-3', })
        widgets['magnitude'] = forms.Select(attrs={'class': 'form-control  mb-3', })
        widgets['duration'] = forms.Select(attrs={'class': 'form-control  mb-3', })
...
class Jinshi_degrees_awardedForm(forms.ModelForm):
    class Meta:
        ...
        widgets = dict(commonwidgets)
        widgets['emperor'] = forms.TextInput(attrs={'class': 'form-control  mb-3', })
        widgets['jinshi_degrees_awarded'] = forms.NumberInput(attrs={'class': 'form-control  mb-3', })
        widgets['population_in_year_x'] = forms.NumberInput(attrs={'class': 'form-control  mb-3', })
...
class ExaminationForm(forms.ModelForm):
    class Meta:
        ...
        widgets = dict(commonwidgets)
        widgets['examination'] = forms.TextInput(attrs={'class': 'form-control  mb-3', })
        widgets['no_of_participants'] = forms.NumberInput(attrs={'class': 'form-control  mb-3', })
        widgets['degrees_awarded'] = forms.NumberInput(attrs={'class': 'form-control  mb-3', })
        widgets['passing_ratio'] = forms.NumberInput(attrs={'class': 'form-control  mb-3', })
        widgets['place'] = forms.TextInput(attrs={'class': 'form-control  mb-3', })
        widgets['ratio_examiner_per_candidate'] = forms.NumberInput(attrs={'class': 'form-control  mb-3', })
        widgets['no_of_examiners'] = forms.NumberInput(attrs={'class': 'form-control  mb-3', })
...
class Taiping_rebellionForm(forms.ModelForm):
    class Meta:
        ...
        widgets = dict(commonwidgets)
        widgets['taiping_rebellion'] = forms.TextInput(attrs={'class': 'form-control  mb-3', })
        widgets['rebel'] = forms.TextInput(attrs={'class': 'form-control  mb-3', })
        widgets['place'] = forms.TextInput(attrs={'class': 'form-control  mb-3', })
        widgets['ethnic_composition'] = forms.TextInput(attrs={'class': 'form-control  mb-3', })
        widgets['family_background'] = forms.TextInput(attrs={'class': 'form-control  mb-3', })
        widgets['role'] = forms.TextInput(attrs={'class': 'form-control  mb-3', })
        widgets['rank'] = forms.TextInput(attrs={'class': 'form-control  mb-3', })
        widgets['civil_examination'] = forms.TextInput(attrs={'class': 'form-control  mb-3', })
...
class Worker_wageForm(forms.ModelForm):
    class Meta:
        ...
        widgets = dict(commonwidgets)
        widgets['worker_wage'] = forms.TextInput(attrs={'class': 'form-control  mb-3', })
        widgets['area'] = forms.TextInput(attrs={'class': 'form-control  mb-3', })
        widgets['unskilled_construction'] = forms.NumberInput(attrs={'class': 'form-control  mb-3', })
        widgets['skilled_construction'] = forms.NumberInput(attrs={'class': 'form-control  mb-3', })
        widgets['number_of_districts_with_available_data'] = forms.NumberInput(attrs={'class': 'form-control  mb-3', })
        widgets['unskilled_arms_manufacturer'] = forms.NumberInput(attrs={'class': 'form-control  mb-3', })
        widgets['population_in_millions_in_1787'] = forms.NumberInput(attrs={'class': 'form-control  mb-3', })
