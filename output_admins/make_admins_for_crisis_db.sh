...
file_1="1_full_admins.py"

merged_file="all_files_merged.py"
source_abs_dir="/home/majid/dev/seshat/helpers/output_admins/"
destination_abs_dir="/home/majid/dev/seshat/seshat/seshat/apps/crisisdb/"
destination_file="admins.py"

rm $source_abs_dir$merged_file
cat  $source_abs_dir$file_1 > $source_abs_dir$merged_file
